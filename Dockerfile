...
RUN install -d -m 0700 -o 65532 -g 65532 /out/probe-data /out/probe-secrets /out/probe-ca-private /out/probe-ca-public
...
COPY --from=build --chown=nonroot:nonroot /out/probe-secrets/ /var/lib/server-probe-secrets/
